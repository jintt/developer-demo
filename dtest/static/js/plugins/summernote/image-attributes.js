    ...
    $.extend(true,$.summernote.lang,{
        ...
        'zh-CN':{ /* Chinese */
            imageAttributes:{
                ...
                tooltip:'图片提示',
                tooltipShape:'图片形状',
                tooltipShapeOptions: [ '自适应', '圆角', '圆形', '缩图', '无' ],
                pluginImageTitle:'图片属性',
                pluginLinkTitle:'链接属性',
                title:'标题',
                alt:'图片说明',
                class:'类',
                classSelect:'选择 类',
                ...
                rel:'描述',
                relBlank:'不使用链接说明',
                relAlternate:'替代说明: 链接替代说明文件',
                relAuthor:'作者: 链接来源位置',
                relBookmark:'书签: 提供加入书签',
                relHelp:'帮助: 链接帮助文件',
                relLicense:'版权: 链接版权宣告页面',
                relNext:'下一步: 链接到下一个被选择的页面',
                relNofollow:'不追踪',
                relNoreferrer:'NoReferrer: 发送时取消 HTTP 头',
                relPrefetch:'预存: 启用预加载',
